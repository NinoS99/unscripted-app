...
import UserRecentContent from '@/components/UserRecentContent';
import UserPopularContent from '@/components/UserPopularContent';
    ...
    <div className="min-h-screen bg-gray-900 container mx-auto">
      ...
      <div className="container mx-auto px-2 py-2 md:px-8 md:py-8 bg-gray-900">
        ...
        <div className="hidden md:flex flex-row gap-8">
          {/* Left Column - Stats and Recent Content */}
          ...
          {/* Right Column - Activity Feed and Popular Content */}
