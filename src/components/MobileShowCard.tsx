...
export default function MobileShowCard({
    show,
}: {
    show: MobileShowCardProps;
}) {
        ...
        >
            <div className="flip-card-inner">
                ...
                <div className="flip-card-front">
                    <div className="bg-gray-300 rounded-xl shadow overflow-hidden flex flex-col">
                        <div className="aspect-[2/3] relative">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-2">
                                <h1 className="text-sm font-bold text-white mb-0">
                                    {show.name}
                                </h1>
                            </div>
                        </div>
