...
export default function DiscussionsPage({
    ...
    const getPosterPath = (isDesktop: boolean = false) => {
        switch (entityType) {
            case "show":
            ...
            case "episode":
                if (isDesktop) {
                    // On desktop, prefer season poster or show poster over episode still
                    return (
                        availableImages?.seasonPosterPath ||
                        availableImages?.showPosterPath ||
                        entity?.stillPath
                        ...
                        <div className="mt-2">
                            ...
                            <div className="flex items-center gap-4 text-gray-300 text-sm">
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <span>
                                        {totalWatched} user
                                        {totalWatched !== 1 ? "s" : ""} have
                                        watched this {entityType}
                                    </span>
                                </div>
                            </div>
